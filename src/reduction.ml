...
let build_trace state =
  ...
  if !Param.html_output then
    Display.Html.display_goal Display.term_to_term noninterftest_to_string final_state
  else
    Display.Text.display_goal Display.term_to_term noninterftest_to_string final_state;
