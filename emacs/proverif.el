...
(defvar proverif-pi-kw '("among" "and" "choice" "clauses" "data" "elimtrue" "else" "equation" "event" "free" "fun" "if" "in" "let" "new" "noninterf" "not" "nounif" "out" "param" "phase" "putbegin" "pred" "private" "process" "query" "reduc" "suchthat" "then" "weaksecret") "ProVerif keywords")
